...
import com.garcal.erp.DAO.basedatos.VehiculosModelosDAO;
...
public class VehiculosModelosResource {

    @Context
    private UriInfo context;

    public VehiculosModelosResource() {
    }
    ...
    public Response getJson(@PathParam("idEmpresa") Integer idEmpresa) {
        ...
        ArrayList<VehiculosModelos> detail = VehiculosModelosDAO.selectAll(idEmpresa);
