...
import com.garcal.erp.DAO.basedatos.VehiculosMarcasDAO;
 ...
 * @author User
 */
@Path("vehiculosmarcas")
public class VehiculosMarcasResource {

    @Context
    private UriInfo context;

    public VehiculosMarcasResource() {
    }
    ...
    public Response getJson(@PathParam("idEmpresa") Integer idEmpresa) {
        ...
        ArrayList<VehiculosMarcas> detail = VehiculosMarcasDAO.selectAll(idEmpresa);
