...
import com.garcal.erp.DAO.basedatos.VehiculosTiposDAO;
 ...
 */
@Path("vehiculostipos")
public class VehiculosTiposResource {

    @Context
    private UriInfo context;

    public VehiculosTiposResource() {
    }
    ...
    public Response getJson(@PathParam("idEmpresa") Integer idEmpresa) {
        ...
        ArrayList<VehiculosTipos> detail = VehiculosTiposDAO.selectAll(idEmpresa);
